...
# MAGIC ## やってみよう
# MAGIC
# MAGIC **Genie Code に聞きながら挑戦してみましょう。**
# MAGIC
# MAGIC 1. **VaR の信頼水準を変更**: Genie Code に「VaR99 を VaR95 に変更するにはどこを書き換えればいい？」と聞いて、変更して再実行しましょう。VaR95 と VaR99 でどちらの絶対値が大きいですか？その理由も Genie Code に聞いてみましょう
# MAGIC 2. **別の国でスライス**: Genie Code に「ペルーの代わりにメキシコの業種別リスク寄与度を見たい」と聞いて、コードを変更してみましょう。メキシコの方が業種が分散していることが確認できるはずです
