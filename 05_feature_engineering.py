...
# MAGIC ## やってみよう
# MAGIC
# MAGIC **Genie Code（ノートブック右側のAIアシスタント）に聞きながら進めてみましょう。**
# MAGIC
# MAGIC 1. **ボラティリティウィンドウを変更**: Genie Code に「ボラティリティの計算ウィンドウを90日から30日に変えるにはどこを変更すればいい？」と聞いて、変更して再実行してみましょう。結果がどう変わりましたか？
# MAGIC 2. **相関行列を読む**: 相関ヒートマップを見て、Genie Code に「S&P500とTREASURYの相関が負になる理由を教えて」と聞いてみましょう。フライト・トゥ・クオリティの概念が学べます
